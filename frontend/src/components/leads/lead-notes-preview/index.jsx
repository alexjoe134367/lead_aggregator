...
import { BreadCrumbContainer, LeadNotesContainer, LeadFormContainer, LeadsContainer, EmailFormContainer } from "@containers";
                                    ...
                                    <Grid.Column className="circle-button-groups">
                                        <div className={'ui secondary menu leadnotes'}>
                                            {/* <Button circular className='email icon'
                                                ...
                                                <Button circular className='email icon'
                                                onClick={this.props.showModal.bind(this, { ...lead, company_id: lead.company.id, show: true})} 
                                                ><Icon className='ti-mail-forward ti icon'/></Button>
                                            {
                                                twilioToken && <Button circular className={(onPhone ? 'icon endCall' : 'icon onCall')}  onClick={this.onCall} ><Icon className='ti-phone ti icon'/></Button>
                                            }

                                            <Button circular className='sms icon'
                                                onClick={this.setSMSModal} ><Icon className='ti-device-mobile-message ti icon'/></Button>

                                            <Button circular className='editlead icon'
                                                onClick={this.props.loadForm.bind(this, {
                                                    ...lead,
                                                    company_id: lead.company.id,
                                                    show: true
                                                })} ><Icon className='ti-pencil ti icon'/></Button>
...
export default compose(BreadCrumbContainer, LeadsContainer, LeadNotesContainer, LeadFormContainer, EmailFormContainer )(LeadNotes);
