...
class Leads extends Component {
  ...
  render() {
    const { companyId, previewLeadId } = this.state;
...
export default compose(BreadCrumbContainer, DealsContainer, CompaniesContainer, LeadsContainer, LeadFormContainer, EmailFormContainer)(Leads);
