                            ...
                            <Grid.Column  style={{textAlign: 'center'}}>
                                <div className={'ui secondary menu leadnotes'}>
                                    <Button circular className='email icon'
                                            as='a' href={`mailto:${lead.email}`}><Icon className='icon ti-mail-forward ti'/></Button>
                                    ...
                                    <Button circular className='editlead icon'
                                        ...
                                        show: true
                                    })}><Icon className='icon ti-pencil ti'/></Button>
                                    {
                                        twilioToken && <Button circular className={(onPhone ? 'endCall icon' : 'onCall icon')}  onClick={this.onCall} ><Icon className='icon ti-phone ti'/></Button>
                                    }
                                </div>
                            </Grid.Column>
