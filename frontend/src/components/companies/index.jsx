              ...
              <Grid.Column>
                <Menu secondary>
                  <Menu.Menu position='right'>
                    ...
                    <Button color='teal' className="new-campaign" onClick={this.props.loadForm.bind(this, { show: true })} title='New Company'><i className="flaticon stroke plus-1  icon"></i></Button>
                  </Menu.Menu>
                </Menu>
              </Grid.Column>
            </Grid>
                    ...
                    <Table.Row key={index}>
                      ...
                      <Table.Cell onClick={() => this.onShowCompanyStats(company)}>
                        <Link to={`/companies/${company.id}/agents`}>
                          {company.agents && company.agents.map((agent, i) => <Fragment key={i}>
