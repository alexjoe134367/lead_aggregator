...
class EntityModal_email extends Component {
    state = {
        formSaved: false,
    };
    ...
    onSave = () => {
        ...
        if (this.validate()) {
            ...
            this.props.sendEmail(this.props.form);
        }
    };
    ...
    onCancel = () => {
        this.props.closeForm({ show: false });
        this.setState({
            formSaved: false,
        })
    };
    ...
    render() {
        ...
        return (
            <Modal className='freshAppEntityModal'
                ...
                centered={false}
                size={rest.size || 'tiny'}
                onClose={this.props.closeForm.bind(this,{ show: false })}>
...
export default compose(MessagesContainer)(EntityModal_email);
