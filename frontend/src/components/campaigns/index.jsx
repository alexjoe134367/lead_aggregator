...
import {
  Segment, Confirm, Header, Menu, Grid, Button, Table, Pagination, Tab
...
class Campaigns extends Component {
  ...
  onShowArch = (e) => {
    if (this.state.integrationTab !== e.target.text) {
      this.setState({
        openOverall: true,
      })
      this.setState({integrationTab: e.target.text});
      ...
      <div className={openOverall ? 'Campaigns sidebarOpened' : 'Campaigns'}>
        ...
        <Segment attached='top'>
          ...
          <div className="top note">
            When you remove an agent from a company, it will also be removed from all integrations that belong to that company. <a className="item" href="https://convertlead.ladesk.com/137942-Getting-Started-with-ConvertLead" target="react/jsx-no-target-blank">Learn more</a>
          </div>
                  ...
                  <Table.Row key={index} onClick={this.onOpenCampaigns}>
                    <Table.Cell>
                      {
                        campaign.integration === 'FACEBOOK'
                          ? <Button circular className='facebookbut icon'><i className="facebook icon"/></Button>
                          : null
                      }
                      {
                        campaign.integration === 'ZAPIER'
                          ? <Button circular className='icon zapierbut integration'
                          ><i className="icon-zapier icon"></i></Button>
                          : null
                      }
                      {
                        campaign.integration === 'CLICKFUNNELS'
                          ? <Button circular className='clickfunnelsbut icon integration'
                            ><i className="icon-clickfunnels icon"/></Button>
                      ...
                      }
                      {
                        campaign.integration === 'WEBHOOK'
                          ? <Button circular className='webhookbut icon integration'
                             ><i className="icon-webhook icon"/></Button>
                          : null
                      }
                      {
                        campaign.integration === 'INSTAPAGE'
                          ? <Button circular className='instapagebut icon integration'
                           ><i className="icon-instapage icon"/></Button>
                          : null
                      }
                      {
                        campaign.integration === 'UNBOUNCE'
                          ? <Button circular className='unbouncedbut icon integration'
                            ><i className="icon-unbounce icon"/></Button>
                          : null
                      }
                      {
                        campaign.integration === 'OPTIN_FORM'
                          ? <Button circular color="purple" className="optin icon integration"><i className="ti ti-forms"/></Button>
                          : null
                      }
                    </Table.Cell>
                    <Table.Cell>
                    ...
                    <Table.Cell>
                      ...
                      <div className="table-cell-value">
                        <Link to={`/companies/${campaign.company_id}/campaigns/${campaign.id}/leads`}>
