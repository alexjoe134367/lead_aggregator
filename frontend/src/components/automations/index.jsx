...
class Campaigns extends Component {
  ...
  drawSvg() {
    ...
    this.props.actions.forEach(action => {
      ...
      if (this.checkIsAllowedForHorizontalActions(action) && action.children) {
        ...
        const y = (action.index > 1 ? 265 : 290);
  ...
  drawHorizontalActions(horizontalActions, parent) {
    ...
    horizontalActions.forEach(action => {
      ...
      const y = (parent.index > 1 ? parent.index * 265 : offsetOnY);
              ...
              <Menu secondary>
                <Menu.Menu position='right'>
                  <div className="buttonsToScale">
                    <Button className="small-transparent" onClick={this.scaleUp} labelPosition='left'><i
                      aria-hidden="true" className="flaticon stroke zoom-in-1  icon"></i></Button>
                    <Button className="small-transparent" onClick={this.scaleDown} labelPosition='left'><i
