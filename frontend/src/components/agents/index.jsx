                    ...
                    <Segment basic>
                        ...
                        <Loader />
                        {
                            agents.map((agent, index) => (
                                <div key={index} data-id={agent.id} className="agentContainer" >
                                            ...
                                            agent.companies && (
                                                <div className="campaignNames">
                                                    <span>assigned to</span>
                                                    {
                                                        ...
                                                        agent.companies && agent.companies.map(({ name, id }) => <div key={id} className="campaignName">{name}</div>)
                                                    }
                                                </div>
                                            )
                                        }
