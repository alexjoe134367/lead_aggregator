    ...
    function () {
        ...
        Route::group(['namespace' => 'Api\Management\Company'], function () {
            Route::prefix('company')->group(function () {
                ...
                Route::patch('companies/{id}/deals/{deal}/campaigns/{campaign_id}', 'CampaignController@campaignUpdate')->middleware('scope:CAMPAIGN_READ,CAMPAIGN_WRITE');
