...
<div class="emailbody" style="width:100%; height:100%; display:block; margin:0 auto; background:#f1f4f5; padding: 60px 0;">
	<div class="toplogocont" style="text-align:center; display:block; width:100%; "><img src="https://app.convertlead.com/img/logo.png" style="width: 80px; margin: 10px auto !important; text-align: center; padding: 15px; display:block;"></img></div>
	<div class="bigcont" style="max-width: 320px;background: #fff;border: 1px solid #dfdff0 !important;padding: 70px 55px 55px 55px;margin: 0 auto;border-radius: 10px;color: #354771;box-shadow: 0 1px 1px rgba(225,225,240,.9);">
		<p style="font-size: 18px; font-family: Arial, sans-serif; font-weight: 400; line-height: 26px; ">Hey {{$company->name}}, <br></br> Your ConvertLead company account has just been created.<br></br>  Welcome!</p>
		...
		<h1 style=" font-size: 17px; font-family: Arial, sans-serif; font-weight: 600; color:#3c3a4e; ">User: {{$company->email}}</h1>
