...
class AgentController extends Controller
{
    ...
    public function store(Request $request, Agent $agent)
    {
        ...
        $agencyRow = AgencyCompany::where("company_id", $userId)->first();
        $request->merge(['agent_agency_id' => $agencyRow->agency_id]);
        $agent->createAgent($request->only(['name', 'agent_agency_id', 'phone', 'avatar_id', 'email', 'password', 'password_confirmation']));
